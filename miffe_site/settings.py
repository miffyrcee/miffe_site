...
SECRET_KEY = 'tmg0$x3!gt%4#1-_-=f=)+!_z=@@^lp6u8td%3&i&rnwo!4ae*'
...
DJANGO_TELEGRAMBOT = {
    ...
    'WEBHOOK_SITE' : 'https://miffe.site',
    #  'WEBHOOK_PREFIX' : '/prefix', # (Optional[str]) # If this value is specified,
                                  # a prefix is added to webhook url

    'WEBHOOK_CERTIFICATE' : '/etc/nginx/ssl/miffe_site.pem', # If your site use self-signed
